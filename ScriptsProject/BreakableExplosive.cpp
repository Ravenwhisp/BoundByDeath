...
void BreakableExplosive::onBreak()
{
    ...
    GameObject* dustEffect = GameObjectAPI::instantiatePrefab("Assets/Prefabs/Particles/Explosion.prefab", TransformAPI::getGlobalPosition(m_brokenObjectTransform), Vector3(0.0f, 0.0f, 0.0f));
