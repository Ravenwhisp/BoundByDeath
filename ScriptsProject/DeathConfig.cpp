...
IMPLEMENT_SCRIPT_FIELDS(DeathConfig,
	...
	FIELD_GROUP_COLLAPSE("Basic Attack",
		...
		SERIALIZED_FLOAT(m_basicAttackLockDuration, "Attack Lock Duration", 0.05f, 2.0f, 0.05f),
		SERIALIZED_FLOAT(m_basicFinalHitLockDuration, "Final Hit Lock Duration", 0.05f, 3.0f, 0.05f),
	...
	FIELD_GROUP_COLLAPSE("Charged Attack",
		...
		SERIALIZED_FLOAT(m_chargedAttackLockDuration, "Attack Lock Duration", 0.05f, 2.0f, 0.05f),
		SERIALIZED_FLOAT(m_chargedFinalHitLockDuration, "Final Hit Lock Duration", 0.05f, 3.0f, 0.05f),
