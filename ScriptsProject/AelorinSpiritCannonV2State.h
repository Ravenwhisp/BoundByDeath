...
class AelorinSpiritCannonV2State : public StateMachineScript
{
	DECLARE_SCRIPT(AelorinSpiritCannonV2State)

public:
	explicit AelorinSpiritCannonV2State(GameObject* owner);
