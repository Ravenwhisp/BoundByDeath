...
void BreakableObject::breakObject()
{
    ...
    if (m_brokenObjectTransform != nullptr)
    {
		...
		GameObject* dustEffect = GameObjectAPI::instantiatePrefab("Assets/Prefabs/Particles/Dust_2.prefab", TransformAPI::getGlobalPosition(m_brokenObjectTransform), Vector3(0.0f, 0.0f, 0.0f));
    }
